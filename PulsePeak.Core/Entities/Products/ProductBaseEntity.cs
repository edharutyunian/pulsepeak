...
namespace PulsePeak.Core.Entities.Products
{
    ...
    {
        public Merchant Owner { get; set; } // required -- represents WHO is the owner of the Product || can also be named as Brand, but it really depends 
        public ICategory Category { get; set; } // required -- but need to implement the ICategory stuff end-to-end
        public IUserAccount CreatedByID { get; set; } // required -- this is should be the Merchant.ID 
